...
import { home, title, form } from './../styles/home.module.scss';

const Home = props => {

    return (
        <div className={home}>
            <span className={title}>GitHub Issue Explorer</span>
            <div className={form}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="10%" height="50%">
